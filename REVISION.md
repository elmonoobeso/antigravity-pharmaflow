...
- [ ] Lote 3b banco de pruebas ML: datos sinteticos (patron conocido / ruido), fugas en todas las variables, etiquetas barajadas, backtest al horizonte real del pedido.
